    ...
    <div id="horiz_ruler_2">
      ...
      <div id="news_">
        ...
        <!-- ================================ ITEM ESQUERDA ==================================== -->
          ...
          <div id="subitem_multimedia_foto"><img src="<?php $record = $db->query_multimedia_imagem(19);

		echo $record; ?>" /></div>

            <div class="texto_arial_10"  id="subitem_multimedia_brown">VÍDEOS

              <p class="text_titulo"><a href="multimedia.php?id=19" class="text_titulo"><?php $record = $db->query_multimedia_titulo(19);

		echo $record; ?></a> </p>

              <div id="btn_link_multimedia_2lines"><a href="multimedia.php?id=19"><img src="../images/btn_multimedia.png" /></a></div>
		...
		echo $record; ?></a></p>
          ...
          <div id="subitem_multimedia_foto"><img src="<?php $record = $db->query_multimedia_imagem(18);

		echo $record; ?>" /></div>

            <div id="subitem_multimedia_brown" class="texto_arial_10">FOTOS

              <p class="text_titulo"><a href="multimedia.php?id=18" class="text_titulo"><?php $record = $db->query_multimedia_titulo(18);
