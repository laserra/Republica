    ...
    <div id="horiz_ruler_2">
      <div id="news_">
        ...
        <!-- ================================ ITEM ESQUERDA ==================================== -->
          ...
          <div id="subitem_multimedia_foto"><img src="<?php $record = $db->query_multimedia_imagem(12);
		echo $record; ?>" /></div>
            <div class="texto_arial_10"  id="subitem_multimedia_brown">VÍDEOS
              <p class="text_titulo"><a href="multimedia.php?id=11" class="text_titulo"><?php $record = $db->query_multimedia_titulo(12);
		echo $record; ?></a> </p>
              <div id="btn_link_multimedia_2lines"><a href="multimedia.php?id=11"><img src="../images/btn_multimedia.png" /></a></div>
            </div>
          </div>
          
          <!-- ================================ ITEM CENTRO ==================================== -->
          <div id="item_multimedia_center">
          	<div id="subitem_multimedia_foto"><img src="<?php $record = $db->query_multimedia_imagem(4);
		echo $record; ?>" /></div>
            <div class="texto_arial_10" id="subitem_multimedia_purple">FOTOS
              <p class="text_titulo"><a href="multimedia.php?id=7" class="text_titulo"><?php $record = $db->query_multimedia_titulo(4);
		echo $record; ?></a></p>
              <div id="btn_link_multimedia"><a href="multimedia.php?id=4"><img src="../images/btn_multimedia.png" /></a></div>
            </div>
          </div>
		...
		echo $record; ?></a></p>
              <div id="btn_link_multimedia_2lines"><a href="multimedia.php?id=5"><img src="../images/btn_multimedia.png" border="0" /></a></div>
            </div>
          </div>
        </div>
        <!-- ================================ TERMINA LINHA 1 ==================================== -->
