package 
{
	...
	public class Main extends MovieClip
	{
		...
		private function carregaFotos():void {
			...
			xml_fotosLoader.load(new URLRequest("instituicoes_simbolos.xml"));
		...
		function loadXMLFotos(evt:Event):void {
			try {
				...
				xml_texto=xml_FotosData.foto.descr;
		...
		private function incrementaFoto(evt:MouseEvent){
			...
			if(uiActual==0){
				...
				texto_tx.text=xml_texto[aux_nr];
				uiActual=1;
			}else{
