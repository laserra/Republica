...
<title>Republica 2010 - Breves - <?php 
			$record = $db->query_breves_titulo($noticia);
			echo $record;
		  ?></title>
...
<div id="Content">
  ...
  <div id="horiz_ruler_4"><img src="../images/hruler.png" width="882" height="16" /></div>
    ...
    <div id="nav_nxt"><img src="../images/datas_bt.png" border="0" /></div>
    <div id="nav_spacer"><img src="../images/spacer.png" width="25" height="10" /></div>
  ...
  <div id="news_2">
    <!-- Barra topo news -->
    <div id="columnText_breves">
    <div id="top_bar_nlusa_1stHalf">
      <div class="textbox">
        <div class="text_subtitulo_wh"><img src="../images/breves_badge.png"/></div>
    	...
    	<div class="text_lead">
    	  <?php 
			$record = $db->query_breves_lead($noticia);
			echo $record;
		  ?>
   	  </div>
        <p>
        <div class="text_normal">
        	<?php 
			$record = $db->query_breves_texto($noticia);
			echo $record;
		  ?>
        </div>
         <p>
        <div class="text_autor">
        	<?php 
			$record = $db->query_breves_autor($noticia);
			echo $record;
		  ?>
        </div>
    </div>
    ...
    <!-- coluna foto -->
    <div id="columnPhoto_breves">
      <div id="breves_flash_container"><object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="256" height="356">
        <param name="movie" value="noticias_slideshow.swf" />
        <param name="quality" value="high" />
        <param name="wmode" value="opaque" />
        <param name="swfversion" value="6.0.65.0" />
        <!-- This param tag prompts users with Flash Player 6.0 r65 and higher to download the latest version of Flash Player. Delete it if you don’t want users to see the prompt. -->
        <param name="expressinstall" value="../Scripts/expressInstall.swf" />
        <param name="FlashVars" value="media=<?php $record = $db->query_breves_xml($noticia);echo $record; ?>" />
        <!-- Next object tag is for non-IE browsers. So hide it from IE using IECC. -->
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="noticias_slideshow.swf" width="256" height="356">
          <!--<![endif]-->
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="6.0.65.0" />
      ...
      <div id="columnOutrosArtigos_breves">
    	<?php 
			$record = $db->query_breves_lista($noticia);
			echo $record;
		  ?>
    </div>
  ...
  <div class="text_photo_2col_318px" id="horiz_ruler_2"><center>Todos os direitos reservados. O Almanaque da República é um produto da
Lusa elaborada como apoio da Comissão Nacional para as Comemorações do
