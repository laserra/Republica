...
<hr>
<p class="navegacao">Inserir novo artigo</p>
<p class="navegacao"><table width="100%" border="0">
              <tr>
                ...
                - O ficheiro XML já deve estar configurado com as fotos, que está a fazer upload.<p>* - Campos obrigat&oacute;rios</th>
              </tr>
              <tr bgcolor="#FF0000">
...
<form action="ok_artigo.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <table width="60%" border="0" align="center" cellpadding="4">
          ...
          <tr bgcolor="#E9C7C1">
            <td bgcolor="#99CCCC" class="texto" onfocus="MM_validateForm('titulo','','R','lead','','R','texto','','R');return document.MM_returnValue">Miniatura Artigos (77x56) *</td>
 ...
 ?>' size="2" readonly="readonly"/>
            ...
            <table width="100%" border="0">
              <tr>
                <th bgcolor="#FF3300" scope="col" class="texto"><img src="imagens/aviso.png" width="32" height="32" /><br />
                  - O ficheiro PHP já deve estar configurado com o nome do ficheiro e o n&uacute;mero do artigo a mostrar.<br />
                - O ficheiro XML já deve estar configurado com as fotos, que está a fazer upload.<p></th>
              </tr>
            </table>
            <p>&nbsp;</p>
            <p>
