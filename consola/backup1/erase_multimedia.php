...
<p>
  <?php
	...
	print("<span class='navegacao'>Tem a certeza que quer apagar a multimédia com a seguinte referência: ".$registo[1]."</span>");
?>
</p>
<table width="10%" border="0" align="center" cellpadding="4">
  <tr>
    <td bgcolor="#FFFF00">
    <form action="eraseok_multimedia.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <label>
  ...
  <tr bgcolor="#009933">
    <td><form id="form2" name="form2" method="post" action="list_multimedia.php">
      <label>
      <div align="center">
