...
<?php
	...
	if($result){
		print('A multimédia foi eliminada com sucesso.<br><form id="form2" name="form2" method="post" action="list_multimedia.php">
			  <label>
			  <div align="center">
		...
		print('Ocorreu um erro a apagar esta multimedia. Verifique a lista e tente de novo.<br><form id="form2" name="form2" method="post" action="list_multimedia.php">
			  <label>
			  <div align="center">
				<input type="submit" name="button2" id="button2" value="Voltar" />
			  </div>
