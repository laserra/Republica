...
<p>
  <?php
	...
	print("<span class='navegacao'>Tem a certeza que quer apagar a noticia com a seguinte referência: ".$registo[1]."</span>");
?>
</p>
<table width="10%" border="0" align="center" cellpadding="4">
  ...
  <tr bgcolor="#009933">
    <td><form id="form2" name="form2" method="post" action="list_noticias.php">
      <label>
      <div align="center">
