...
<table width="90%" border="0" cellpadding="4">
  <tr>
    ...
    <td width="9%" bgcolor="#9BB1BF" class="texto_white"><div align="center">Secção</div></td>
  ...
  <?php
	...
	if($resultado){
		...
		while($registo=mysql_fetch_array($resultado)){
			...
			//Busca a descrição dos cilindros consoante o indice guardado na tabela dos motores
