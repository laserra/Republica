...
<title>Republica 2010 - Datas - O regic&iacute;dio no Terreiro do Pa&ccedil;o</title>
...
<div id="Content">
  ...
  <div id="horiz_ruler_4"><img src="../images/hruler.png" width="882" height="16" /></div>
    ...
    <div id="nav_agd"><a href="../noticiaslusa/nlusa.php"><img src="../images/arquivo_bt.png" width="154" height="30" /></a></div>
  </div>
    ...
    <div id="top_bar_news_1stHalf">
      <div class="textbox">
        ...
        <?php 
		  ...
		  ?> 
          - <?php 
			$record = $db->query_artigo_data($artigo);
			echo $record;
		  ?>
...
<div id="columnText">
  ...
  <div id="horiz_ruler"><img src="../images/hruler.png"/></div>
   <div class="text_photo_2col_318px" id="horiz_ruler_2"><center>&copy; LUSA - 2010</center></div>
  <!-- Cronologia -->
  <!-- Carrossel em Flash -->
  <!-- Régua horizontal -->
  <!-- Fim Contents-->
